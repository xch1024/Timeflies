...
import com.example.timeflies.model.ScheduleSupport;
import com.example.timeflies.utils.ColorUtils;

import java.util.Calendar;
import java.util.List;

public class OnDateBuildAdapter {
    ...
    protected View onBuildMonthLayout(LayoutInflater mInflate, int width, int height) {
        View first = mInflate.inflate(R.layout.item_dateview_month, null, false);
        //月份设置
        textViews[0] = first.findViewById(R.id.week_month);
        layouts[0] = null;
    ...
    protected View onBuildDayLayout(LayoutInflater mInflate, int pos, int width, int height) {
        View v = mInflate.inflate(R.layout.item_dateview_week, null, false);
